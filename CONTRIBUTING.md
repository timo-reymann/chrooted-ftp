...
In short, when you submit code changes, your submissions are understood to be under the same ["Climate Strike" License Version 1.0 (Draft)](https://github.com/timo-reymann/chrooted-ftp/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.
